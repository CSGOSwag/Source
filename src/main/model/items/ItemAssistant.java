...
import main.Config;
import main.Server;
import main.model.items.bank.BankItem;
import main.model.items.bank.BankTab;
...
public class ItemAssistant {
	...
	public static final String RARES[] = { "11702", "11704", "11706", "11708", "11718", "11720", "11722", "11724", "11726", "11728", "6737", "11730", "13746", "13748", "13750", "13752", "13754", "13734", "13736", "14484", "15004", "15005", "15006", "15017", "15018", "15019", "15020", "13858", "13861", "13864", "13867", "13870", "13873", "13876", "4151", "2581", "2577", "11335", "4087", "4585", "3140", "6585", "6733", "6735", "6731", "6739", "11710", "11712", "11714", "11286", "11732" };
		...
		while (iterator.hasNext()) {
			...
			if (t != null && t.size() > 0) {
				...
				while (iterator2.hasNext()) {
					...
					if (i.getId() == item.getId() && !isStackable(itemId)) {
						...
						if (isStackable(itemId) && i.getId() == item.getId() - 1) {
	...
	public void addBankItem(int itemId, int amount) {
	...
	public void sendWeapon(int Weapon, String WeaponName) {
		...
		if (WeaponName.equals("Unarmed")) {
		...
		} else if (WeaponName.endsWith("whip") || WeaponName.endsWith("Tenticle")) {
			...
			c.getPA().sendFrame126(WeaponName, 1767);
				...
				|| WeaponName.endsWith("staff") || WeaponName.endsWith("wand") || WeaponName.contains("staff")) {
			...
			c.getPA().sendFrame126(WeaponName, 331);
				...
				|| WeaponName.endsWith("Blowpipe")
				|| WeaponName2.contains("Trident")) {
		...
		} else if (c.playerEquipment[c.playerWeapon] == 12424) {
			c.setSidebarInterface(0, 1764); // accurate, rapid, longrange
			c.getPA().sendFrame246(1765, 200, Weapon);
			c.getPA().sendFrame126(WeaponName, 1767);
		} else if (c.playerEquipment[c.playerWeapon] == 12422) {
			c.setSidebarInterface(0, 328); // spike, impale, smash, block
			c.getPA().sendFrame246(329, 200, Weapon);
			c.getPA().sendFrame126(WeaponName, 331);
		} else {
	...
	public void getRequirements(String itemName, int itemId) {
		c.attackLevelReq = c.defenceLevelReq = c.strengthLevelReq = c.rangeLevelReq = c.magicLevelReq = c.prayerLevelReq = 0;
		...
		if (itemName.contains("dead")) {
			if (!itemName.contains("beads")) {
	...
	public void onyxOption() {
		c.getDH().sendOption2("Amulet of Fury", "Berserker Necklace");
		c.dialogueAction = 46;
	}
	
	public void makeAbbyTent() {
		if (playerHasItem(12004, 1) && playerHasItem(4151, 1)) {
			if (c.playerLevel[c.playerCrafting] >= 80) {
			deleteItem(12004, 1);
			deleteItem(4151, 1);
			addItem(12006, 1);
			c.sendMessage("You successfully make a abyssal tentacle whip!");
			} else {
				c.sendMessage("You need 80 crafting to make the abyssal tentacle whip.");
			} 
		}
	}
	...
	public void createBlessedSpiritShield() {
		if (playerHasItem(13754) && playerHasItem(13734)) {
			deleteItem(13754, 1);
			deleteItem(13734, 1);
			addItem(13736, 1);
		}
	...
	public void createArcane() {
		if (playerHasItem(13746) && playerHasItem(13736)) {
			deleteItem(13746, 1);
			deleteItem(13736, 1);
			addItem(13738, 1);
		}
	...
	public void createDivine() {
		if (playerHasItem(13748) && playerHasItem(13736)) {
			deleteItem(13748, 1);
			deleteItem(13736, 1);
			addItem(13740, 1);
		}
	...
	public void createSpectral() {
		if (playerHasItem(13752) && playerHasItem(13736)) {
			deleteItem(13736, 1);
			deleteItem(13752, 1);
			addItem(13744, 1);
		}
	...
	public void createElysian() {
		if (playerHasItem(13750) && playerHasItem(13736)) {
			deleteItem(13736, 1);
			deleteItem(13750, 1);
			addItem(13742, 1);
		}
	...
	public void makeBlowpipe() { 
		if (c.playerLevel[c.playerCrafting] >= 53) {
		if (playerHasItem(12922)) {
			deleteItem(12922, 1);
			addItem(12926, 1);
			c.sendMessage("You successfully create a blowpipe.");
			} else {
				c.sendMessage("This item requires 53 crafting to make.");
			}
		}
	}
	
	public void makeTSOTD() {
		if (playerHasItem(12932) && playerHasItem(11791)) {
			deleteItem(12932, 1);
			deleteItem(11791, 1);
			addItem(12904, 1);
			c.sendMessage("You successfully make a Toxic Staff of The Dead.");
		}
	}
	
	public void makeSerp() {
		if (c.playerLevel[c.playerCrafting] >= 52) {
		if (playerHasItem(12927)) {
			deleteItem(12927, 1);
			addItem(14613 ,1);
			c.sendMessage("You successfully craft a Serpentine Helmet.");
			}
		} else {
			c.sendMessage("You need 52 Crafting for this.");
		}
	}
	
	public void makeSwamp() {
		if (playerHasItem(11907) && playerHasItem(12932)) {
			deleteItem(11907, 1);
			deleteItem(12932, 1);
			addItem(12899, 1);
			c.sendMessage("You successfully make a Trident of the Swamp.");
		}
	}

    public boolean addItem(int id, int amount, String reason) {
