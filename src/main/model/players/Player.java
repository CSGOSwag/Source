...
public abstract class Player {
	...
	*/
	...
	public int safeTimer = 1000, logoutTimer, dropWealth;
	...
	public boolean runePlate;
	public boolean runeLegs;
	public boolean runeHelm;

	public boolean jadSpawn;
	...
	public boolean smallPouchStored;
	public double crossbowDamage;
	
	public boolean doneLog = false;
	public boolean doneNet1 = false;
	public boolean doneBranch1 = false;
	public boolean doneRope = false;
	public boolean doneBranch2 = false;
	public boolean doneNet2 = false;
	public boolean doneTunnel = false;
	...
	public int snakeKills;
	public int kqKills;
	public int rexKills;
	public int supremeKills;
	public int primeKills;
	...
	public boolean[] playerSkilling = new boolean[24];
	...
	public boolean isBanking = true, isCooking = false, initialized = false,
			...
			splitChat = true, chatEffects = true, acceptAid = false,
	...
	saveDelay, height = 0, playerKilled, pkPoints, totalPlayerDamageDealt,
			...
			defenceLevelReq, strengthLevelReq, rangeLevelReq, magicLevelReq, prayerLevelReq,
	...
	public int teleGrabItem, teleGrabX, teleGrabY, duelCount, underAttackBy,
			underAttackBy2, wildLevel, wildMithLevel, teleTimer, respawnTimer, saveTimer = 0,
			teleBlockLength, poisonDelay;
	public long lastPlayerMove, lastPoison, emptyDelay,  lastPoisonSip, poisonImmune,
	...
	public final int[][] MAGIC_SPELLS = {
			...
			{ 1193, 75, 1979, 161, 162, 163, 32, 37, 0, 0, 0, 0, 0, 0, 0, 0 }
	...
	public boolean doubleHit, usingSpecial, npcDroppingItems, usingRangeWeapon,
			usingBow, usingMagic, castingMagic, Achievement;
	...
	public boolean killedDharok;
	public boolean killedVerac;
	public boolean killedKaril;
	public boolean killedAhrim;
	public boolean killedTorag;
	public boolean killedGuthan;
	...
	//Godwars killcount
		public int bandosGwdKC = 0;
		public int armaGwdKC = 0;
		public int zamGwdKC = 0;
		public int saraGwdKC = 0;
	//End
	...
	public boolean isInBarrows() {		
		if(absX > 3543 && absX < 3584 && absY > 3265 && absY < 3311 || absX > 3520 && absX < 3598 && absY > 9653 && absY < 9750) {
			return true;
		}
		return false;
	}
	...
	public boolean inMithWild() {
		if (absX >= 3000 && absX <= 3100 && absY >= 9500 && absY <= 9600) {
			return true;
		}
		return false;
	}
	...
	public boolean inTheArena() {	
		if (absX > 3331 && absX < 3390 && absY > 3205 && absY < 3259) {
			return true;
		}
		return false;
	}
	...
	public boolean inMulti() {
		if ((absX >= 3136 && absX <= 3327 && absY >= 3519 && absY <= 3607)
				...
				|| (absX >= 2333 && absX <= 2356 && absY >= 3693 && absY <= 3715)
				|| (absX >= 3045 && absX <= 3071 && absY >= 3942 && absY <= 3472)
				|| (absX >= 2897 && absX <= 2924 && absY >= 3598 && absY <= 3627)) {
			return true;
		}
		return false;
	}
	...
	public boolean inIllegalLoginArea() {
