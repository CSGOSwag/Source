...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 401:	
			...
			break;		
		case 23:
			c.getDH().sendStartInfo("As you collect your reward, you notice an awful smell.", "You look below the remaining debris to the bottom of the", "chest. You see a trapdoor. You open it and it leads to a ladder", "that goes down a long ways.", "Continue?");
			break;
		case 24:
		...
		case 4317:
			sendOption2("Yes, I want to @red@skull @bla@myself!", "No, I don't want to be skulled.");
